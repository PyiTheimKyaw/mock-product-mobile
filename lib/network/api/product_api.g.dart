...
class _ProductApi implements ProductApi {
  ...
  Future<List<CategoryVO>?> getAllCategories() async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<CategoryVO>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var _value = _result.data
        ?.map((dynamic i) => CategoryVO.fromJson(i as Map<String, dynamic>))
        .toList();
    return _value;
  }

  @override
  Future<ProductResponse> getProductListByCategory(String slug) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
